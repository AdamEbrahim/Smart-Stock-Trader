...
if __name__ == '__main__':
    ...
    trader = stockTrader(keys['PAPER_API_KEY'], keys['PAPER_SECRET_KEY'], True, (2,2), keys['MONITOR_RESOLUTION'], keys['GUI_SETUP_TIME'], keys['PIR_PIN'], keys['LED_PIN'], keys["LED_PIXELS"], keys['MONITOR_TIMEOUT'])
